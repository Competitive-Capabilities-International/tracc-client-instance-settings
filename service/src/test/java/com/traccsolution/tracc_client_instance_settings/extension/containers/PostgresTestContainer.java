package com.traccsolution.tracc_client_instance_settings.extension.containers;
...
public enum PostgresTestContainer {
    ...
    public static final String tracc_client_instance_settings_APP_USER = "tracc_client_instance_settings_app_user";
    public static final String tracc_client_instance_settings_APP_USER_PASSWORD = "password";
    ...
    PostgresTestContainer() {
        ...
        System.setProperty(SPRING_DATASOURCE_USERNAME, tracc_client_instance_settings_APP_USER);
        System.setProperty(SPRING_DATASOURCE_PASSWORD, tracc_client_instance_settings_APP_USER_PASSWORD);
